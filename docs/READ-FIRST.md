...
| **A control that is present and does nothing** | ✅ *fixed 9 Sep.* Cook mode rendered on every recipe card while 35 of 38 recipes had no card — every dish in the live week included. Karl: *"The Clousto Kitchen app has no cook cards."* **A dead button is the same defect as a line with no price.** Gate a control on the data that makes it work, and let its absence be the message. |
